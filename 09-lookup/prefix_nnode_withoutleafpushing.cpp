...
//	FILE* file;
//	if (DEBUG_FLAG)
//		file = fopen("E:\\UCAS\\wlsy网络实验\\09-lookup\\forwarding-table1.txt", "r");
//	else
//		file = fopen("E:\\UCAS\\wlsy网络实验\\09-lookup\\forwarding-table.txt", "r");
//	char buf[BUF_SIZE];
...
//	if (!DEBUG_FLAG) {
//		FILE* file = fopen("E:\\UCAS\\wlsy网络实验\\09-lookup\\result-step0.txt", "r");
//		char ip_string[BUF_SIZE];
//		int ip_mask;
//		int real_iface_id;
//		int cnt = 0;
...
//		int iface_id = -1;
//		find_node(root, parse_ip_addr(ip_str), 0, &iface_id);
